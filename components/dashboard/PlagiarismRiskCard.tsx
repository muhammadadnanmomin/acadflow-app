      ...
      <Card className="w-full max-w-2xl max-h-[85vh] overflow-y-auto p-6 space-y-5">
        ...
        <div className="border-t pt-3 space-y-2">
          ...
          <p className="text-xs text-gray-400">
            Model: {model || "AI"} | Hybrid scoring: {Math.round(0.3 * 100)}% structural + {Math.round(0.7 * 100)}% semantic
          </p>
        </div>
        ...
        <FadeInSection delay={700}>
          <div className="border-t border-gray-100 pt-3 space-y-1">
            ...
            <div className="flex items-center justify-between text-xs text-gray-400">
              <span>
                Generated by{" "}
                <span className="font-medium text-gray-500">{model || "AI"}</span>
                <span className="mx-1">•</span>
                Hybrid scoring (30% structural + 70% semantic)
              </span>
              <span>
